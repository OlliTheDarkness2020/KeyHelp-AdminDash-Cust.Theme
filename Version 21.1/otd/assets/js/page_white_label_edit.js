...
// setup codemirror
var editorFooter = initCodemirror($('#input-footer')[0], '21.5em', 'text/html');

var editorCss = initCodemirror($('#input-css')[0], '21.5em', 'text/css');

var editorJs = initCodemirror($('#input-js')[0], '21.5em', 'text/javascript');
