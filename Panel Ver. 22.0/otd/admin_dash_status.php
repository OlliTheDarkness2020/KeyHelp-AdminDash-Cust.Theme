...
/* Service Monitor Beginn */
    ...
    case 'raid':
        ...
        if (file_exists($raid))
          ...
          {
            @$rinhalt = NULL;
            echo '<b>Vermutlich lief der Cronjob noch nicht.<br />Entweder warten Sie bis zur Ausführung des Cron oder führen folgenden Befehl auf der Shell aus:<br /><br /><b><u>DEBIAN</u></b><br />"/home/keyhelp/www/keyhelp/theme/otd/test.sh raid"<br /><b><u>UBUNTU</u></b><br />"/home/keyhelp/www/keyhelp/theme/otd/test.sh ubu-raid"<br /><br />Danach sollte diese Meldung verschwunden und die Werte angezeigt werden.';
          }
        echo '
        ...
        if (@$rinhalt == NULL) {
            ...
            if (@@$rinhalt[5][0] != NULL) {
                echo '<tr> <td> <b> ' . @$rinhalt[5][0] . ' </b> </td> <td> <center> ' . @$rinhalt[5][1] . ' </center> </td> </tr>';
            }
            if (@@$rinhalt[6][0] != NULL) {
                echo '<tr> <td> <b> ' . @$rinhalt[6][0] . ' </b> </td> <td> <center> ' . @$rinhalt[6][1] . ' </center> </td> </tr>';
            }
        }
        echo '
				</tbody>
    ...
    case 'smart':
        ...
        if (file_exists($smart)) {
            ...
            @$inhalt = NULL;
            echo '<b>Vermutlich lief der Cronjob noch nicht.<br />Entweder warten Sie bis zur Ausführung des Cron oder führen folgenden Befehl auf der Shell aus:<br /><br /><b><u>DEBIAN</u></b><br />"/home/keyhelp/www/keyhelp/theme/otd/test.sh smart"<br /><b><u>UBUNTU</u></b><br />"/home/keyhelp/www/keyhelp/theme/otd/test.sh ubu-smart"<br /><br />Danach sollte diese Meldung verschwunden und die Werte angezeigt werden.';
        }
        echo '
					<div class="table-container">
						<table class="table is-fullwidth is-striped">
					...
					';
        if (@$inhalt == NULL) {
            echo '<b>Vermutlich lief der Cronjob noch nicht.<br />Entweder warten Sie bis zur Ausführung des Cron oder führen folgenden Befehl auf der Shell aus:<br /><br /><b><u>DEBIAN</u></b><br />"/home/keyhelp/www/keyhelp/theme/otd/test.sh smart"<br /><b><u>UBUNTU</u></b><br />"/home/keyhelp/www/keyhelp/theme/otd/test.sh ubu-smart"<br /><br />Danach sollte diese Meldung verschwunden sein und die Werte angezeigt werden.';
        } else {
...
emergency_lock_active:
    if ($_GET["realtime"] === "teamspeak3_controller")
      ...
      {
        echo '<b> <u> <p style="text-align: center;"> Created 2021-2022 by OlliTheDarkness </p> </u> </b>';
      }
?>
