        ...
        ajax({
            ...
            success: function(response)
            {
                ...
                else
                {
                    ...
                    html+= '  <table class="table is-narrow is-nested-table is-fullwidth">';
                    ...
                    for (var key in response.info)
                    {
                        ...
                        if (key === 'permissions' || key === 'main_domains')
                        {
                            if (info.value.length > 0)
                            {
                                ...
                                html+= '<tr>';
                                html+= '  <td colspan="2">';
                                html+= '    <strong>' + info.label + '</strong><br>';
                                ...
                                {
                                    html+='    <div class="app-show-more-domains has-margin-top-small">';
                                    html+='       <a href="javascript:void(0)">' + hash['lang.show_more'] + ' (' + remainingDomains + ')</a>';
                                    html+='    </div>';
                                }
                        ...
                        else
                        {
                            ...
                            html+= '  <td class="has-no-wrap">' + (info.value === null ? '&#x2014;' : info.value) + '</td>';
                            html+= '</tr>';
                        }
                        html+= "\n";
                    }
