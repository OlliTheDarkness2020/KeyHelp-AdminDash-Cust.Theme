...
//======================================================================================================================
    ...
    $('.app-toggle-advanced-options').on('click', function() {
       var $this = $(this);
       var $icon = $this.find('.app-collapse-indicator i');
       var $content = $('#app-ftp-advanced-settings');
    ...
    $('#app-sftp-create-key').on('click', function() {
        ...
        ajax({
            ...
            success: function(data)
            {
                ...
                $sftpPrivateKey.val(privateKey);
                // Without trigger, on change won't fire on hidden elements.
                $sftpPublicKey.val(publicKey).trigger('change');
            },
            beforeSend: function()
            {
