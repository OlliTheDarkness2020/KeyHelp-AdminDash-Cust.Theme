...
//======================================================================================================================
    ...
    if (!hash['white_label.product_name'])
    {
...
//======================================================================================================================
// Main navigation (collapse menu category)
//======================================================================================================================
    ...
    $('.menu-label').on('click', function() {
        ...
        var cookieName = 'navigation_' + hash['app.area'];

        setCookie(cookieName, JSON.stringify(states));
    });

//======================================================================================================================
// Collapse .card content + footer
//======================================================================================================================

    // Collapse on click and save to cookie.
    $('.card-header.is-collapsible').on('click', function() {
        var $this = $(this);

        toggleCardCollapse($this);

        // Save collapse state of all
        var states = {};
        $('.card-header.is-collapsible').each(function() {
            var $this = $(this);
        ...
        {
            var cookieName = 'card_' + hash['app.area'] + '_' + hash['app.page'];
            setCookie(cookieName, JSON.stringify(states));
        }
    });

    // Collapse at page load.
    var cardCookieCollapsedStates = getCookie('card_' + hash['app.area'] + '_' + hash['app.page']);

    if (cardCookieCollapsedStates)
    {
        states = JSON.parse(cardCookieCollapsedStates);
...
//======================================================================================================================
    ...
    if ($('.tabs').length > 0)
    {
        ...
        $submitButton.on('click', function() {
            var $this = $(this);
            var $form = $this.closest('form');
            var hasTabs = $form.find('.tabs-panel').length > 0;
